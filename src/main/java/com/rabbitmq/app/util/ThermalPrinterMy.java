...
public class ThermalPrinterMy {
	...
	public ThermalPrinterMy(int paperWidth, boolean showLog) {
	...
	public ThermalPrinterMy(int paperWidth, boolean showLog, String printerName) {
